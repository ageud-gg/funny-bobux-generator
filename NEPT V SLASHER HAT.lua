...
warn("cool funny free bobux keyboard simulator")
...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = game:GetService("Players").LocalPlayer.Character.Free
...
kan.Pitch = 1.01
kan.SoundId = "rbxassetid://0" --525289865,1873219898,381991270
kan.Name = "fard"
kan.Looped = false
kan:Play()
...
Character=Player.Character.Free
...
local Hat = AlignChar:FindFirstChild("Back_AccAccessory")
...
Align(Hat.Handle,AlignChar.Free.Model.Part,Vector3.new(0,0.5,0),Vector3.new(0,90,60))
